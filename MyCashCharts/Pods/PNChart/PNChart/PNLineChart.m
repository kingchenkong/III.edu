...
- (void)setYLabels:(NSArray *)yLabels withHeight:(CGFloat)height {
    ...
    if (_showLabel) {
        ...
        for (int index = 0; index < yLabels.count; index++) {
            ...
            PNChartLabel *label = [[PNChartLabel alloc] initWithFrame:CGRectMake(0.0, y, (NSInteger) _chartMarginLeft * 1.5, (NSInteger) _yLabelHeight)];   //    (NSInteger) _chartMarginLeft * 1.5 可調label寬度
...
//            NSInteger x = (index * _xLabelWidth + _chartMarginLeft + _xLabelWidth / 2.0);
            //  offset 關閉
            NSInteger x = (index * _xLabelWidth + 0 + _xLabelWidth / 2.0);
