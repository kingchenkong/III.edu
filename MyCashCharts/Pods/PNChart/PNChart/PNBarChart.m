...
- (void)__addYCoordinateLabelsValues{
    ...
    for (int i = 0; i <= _yLabelSum; i++) {
        ...
        if (_yLabels) {
            ...
            //        labelText =[NSString stringWithFormat:@"%.1f", _yValueMax];
        }
        ...
        if (i < [_yValues count]) {
            NSLog(@"###########");
            NSLog(@"%@", _yValues[i]);
            label.text = [NSString stringWithFormat:@"%@", _yValues[i]];
        } else {
            label.text = @"0%";
        }
        //  #####################
...
//        label.frame = (CGRect){0, sectionHeight * i + _chartMarginTop - (CGFloat)kYLabelHeight/2.0, (CGFloat)_yChartLabelWidth, (CGFloat)kYLabelHeight};
        label.frame = (CGRect){0, 30.0 * i + _chartMarginTop - (CGFloat)kYLabelHeight/2.0, (CGFloat)_yChartLabelWidth, (CGFloat)kYLabelHeight};
